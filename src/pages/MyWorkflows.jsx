...
function MyWorkflows({ workflows, onOpenWorkflow, onOpenWorkflowDetail }) {
  ...
  if (!workflows.length) {
    return (
      <EmptyState
        title="还没有工作流记录"
        description="从工作台或任务库开始一个任务后，这里会出现可继续编辑的流程。"
      />
    );
  }
  ...
  return (
    <section className="library-page">
      <div className="library-page__header">
        <h2 className="library-page__title">我的流程</h2>
      ...
      <div className="library-list">
        ...
        <section className="library-group">
          <div className="library-group__header">
            ...
            <p className="library-group__description">
              优先展示这条流程目前停在哪个步骤、适合从哪里继续，以及已经用过哪些方法。
            </p>
          </div>
            ...
            {visibleWorkflows.map((workflow) => (
              ...
              >
                <div className="flowpilot-card-kicker">
                  <span className="flowpilot-card-kicker__label">流程回顾</span>
                  <span className={`flowpilot-status-badge flowpilot-status-badge--${workflow.status}`}>
                    {workflow.status}
                  </span>
                </div>
                ...
                <div className="flowpilot-card-section">
                  <span className="flowpilot-card-section__label">已使用的方法</span>
