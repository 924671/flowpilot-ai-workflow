...
const plans = [
  ...
  },
  {
    ...
    features: ['多版本生成与继续编辑', '方法记录深度复盘', '自定义工作流模板与模板回填恢复'],
  ...
  },
  {
    ...
    features: ['团队共享模板入口', '统一版本输出口径', '共享方法记录和可复用建议'],
    note: '强化方法复用和协作口径统一，而不是重型后台管理系统。',
    action: '适合团队试用',
    featured: false,
  },
];
...
const capabilityGroups = [
  ...
  {
    title: '模板沉淀与模板回流',
    description: '把上下文结构、版本输出和方法记录反向沉淀为下次入口。',
    coverage: {
      free: '轻量支持',
      pro: '支持',
      team: '重点能力',
...
const faqs = [
  {
    question: '为什么会员方案页不是成长页？',
    answer: 'FlowPilot 的会员方案页用来说明不同方案覆盖的能力范围，而不是构建游戏化成长体系。',
  },
  {
    question: '专业版和团队版的差别是什么？',
    answer: '专业版更关注个人高频复用，团队版更强调团队内部共享模板、统一输出结构和方法沉淀口径。',
  },
  {
    question: '这里会接入支付或注册吗？',
    answer: '当前原型阶段不接入真实支付、登录或权限控制，这一页只展示商业化结构和能力差异。',
  },
];
  ...
  return (
    <section className="library-page">
      <div className="library-page__header">
        ...
        <p className="library-page__description">升级后获得更多工作流额度、版本生成和结果沉淀能力。</p>
      </div>
        ...
        <section className="library-group">
          <div className="library-group__header">
            <div className="library-group__title-row">
              ...
              <span className="library-group__pill library-group__pill--soft">浅色专业风格</span>
            </div>
            <p className="library-group__description">
            ...
            {plans.map((plan) => (
              ...
              >
                <div className="flowpilot-pricing-card__top">
                  ...
                  {plan.featured ? <span className="flowpilot-pricing-card__badge">推荐</span> : null}
                </div>
        ...
        <section className="library-group">
          <div className="library-group__header">
            <div className="library-group__title-row">
              ...
              <span className="library-group__pill library-group__pill--soft">对应产品流程</span>
            </div>
            <p className="library-group__description">
        ...
        <section className="library-group">
          <div className="library-group__header">
            <div className="library-group__title-row">
              ...
              <span className="library-group__pill library-group__pill--soft">页面边界说明</span>
            </div>
          </div>
